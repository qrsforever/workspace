...
void protobuf_AssignDesc_addressbook_2eproto() {
  ...
  static const int AddressBook_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AddressBook, style_),
...
void protobuf_AddDesc_addressbook_2eproto() {
  ...
  ::tutorial::protobuf_AddDesc_facestyle_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "learn.protoB\020OuterAddressBookH\001", 391);
...
#ifndef _MSC_VER
const int AddressBook::kStyleFieldNumber;
...
void AddressBook::InitAsDefaultInstance() {
  style_ = const_cast< ::tutorial::FaceStyle*>(&::tutorial::FaceStyle::default_instance());
}
...
void AddressBook::MergeFrom(const AddressBook& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_style()) {
      mutable_style()->::tutorial::FaceStyle::MergeFrom(from.style());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
