...
class AddressBook : public ::google::protobuf::Message {
 public:
  ...
  inline const ::tutorial::FaceStyle& style() const;
  inline ::tutorial::FaceStyle* mutable_style();
  inline ::tutorial::FaceStyle* release_style();
  inline void set_allocated_style(::tutorial::FaceStyle* style);
...
// required .tutorial.FaceStyle style = 1;
inline bool AddressBook::has_style() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void AddressBook::set_has_style() {
  _has_bits_[0] |= 0x00000001u;
}
inline void AddressBook::clear_has_style() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void AddressBook::clear_style() {
  if (style_ != NULL) style_->::tutorial::FaceStyle::Clear();
  clear_has_style();
}
inline const ::tutorial::FaceStyle& AddressBook::style() const {
  return style_ != NULL ? *style_ : *default_instance_->style_;
}
inline ::tutorial::FaceStyle* AddressBook::mutable_style() {
  set_has_style();
  if (style_ == NULL) style_ = new ::tutorial::FaceStyle;
  return style_;
}
inline ::tutorial::FaceStyle* AddressBook::release_style() {
  clear_has_style();
  ::tutorial::FaceStyle* temp = style_;
  style_ = NULL;
  return temp;
}
inline void AddressBook::set_allocated_style(::tutorial::FaceStyle* style) {
  delete style_;
  style_ = style;
  if (style) {
    set_has_style();
